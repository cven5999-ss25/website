...
Complete the homework programming assignment that is in your project folder for week 2 by **Friday 16th** June on [Posit Cloud]({{< var platforms.posit-cloud >}}content/all)

- hw-02-data-science-lifecycle.qmd

## {{< fa pen-clip >}} Learning reflection

Complete the learning reflection that is in your project folder for week 2 on [Posit Cloud]({{< var platforms.posit-cloud >}}content/all) 
