...
Complete the homework programming assignment that is in your project folder for week 3 on [Posit Cloud]({{< var platforms.posit-cloud >}}content/all)
...
Complete the learning reflection that is in your project folder for week 3 on [Posit Cloud]({{< var platforms.posit-cloud >}}content/all)
